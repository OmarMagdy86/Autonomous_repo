...
class Metaclass_AddThreeInts_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('turtle_control_pkg')
        except ImportError:
            import logging
            import traceback
...
class AddThreeInts_Event(metaclass=Metaclass_AddThreeInts_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<turtle_control_pkg/AddThreeInts_Request, 1>',
        'response': 'sequence<turtle_control_pkg/AddThreeInts_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['turtle_control_pkg', 'srv'], 'AddThreeInts_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['turtle_control_pkg', 'srv'], 'AddThreeInts_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from turtle_control_pkg.srv import AddThreeInts_Request
    ...
    def response(self, value):
        if self._check_fields:
            from turtle_control_pkg.srv import AddThreeInts_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'turtle_control_pkg.srv.AddThreeInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from turtle_control_pkg.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from turtle_control_pkg.srv._add_three_ints import AddThreeInts_Request as Request
    from turtle_control_pkg.srv._add_three_ints import AddThreeInts_Response as Response
    from turtle_control_pkg.srv._add_three_ints import AddThreeInts_Event as Event
