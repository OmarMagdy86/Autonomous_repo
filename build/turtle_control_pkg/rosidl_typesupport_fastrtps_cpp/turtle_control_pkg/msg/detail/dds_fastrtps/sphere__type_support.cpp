...
#include "turtle_control_pkg/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_control_pkg::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_control_pkg::msg::Sphere & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_control_pkg::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtle_control_pkg::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_control_pkg::msg::Sphere *>(
    untyped_ros_message);
...
get_message_type_support_handle<turtle_control_pkg::msg::Sphere>()
{
  return &turtle_control_pkg::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_control_pkg, msg, Sphere)() {
  return &turtle_control_pkg::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
