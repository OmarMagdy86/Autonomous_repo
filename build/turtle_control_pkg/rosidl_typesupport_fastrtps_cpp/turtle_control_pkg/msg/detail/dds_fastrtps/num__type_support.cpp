...
#include "turtle_control_pkg/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_control_pkg::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtle_control_pkg::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_control_pkg::msg::Num *>(
    untyped_ros_message);
...
{
  return &turtle_control_pkg::msg::typesupport_fastrtps_cpp::_Num__handle;
}
