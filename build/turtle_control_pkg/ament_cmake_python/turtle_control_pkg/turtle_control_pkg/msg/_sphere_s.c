...
bool turtle_control_pkg__msg__sphere__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtle_control_pkg.msg._sphere.Sphere", full_classname_dest, 37) == 0);
  }
  turtle_control_pkg__msg__Sphere * ros_message = _ros_message;
  {  // center
...
PyObject * turtle_control_pkg__msg__sphere__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtle_control_pkg.msg._sphere");
